...
public class Game extends Canvas implements Runnable {
    ...
    public Game() {
        ...
        enemy.setUser_id(2);
        user.getPokemons().add(new Pokemon(1, 10, "RAPID ATTACK", 20, "LANZAHOJAS", 20, 120, "Bulbasaur", Pokemon.TypeP.Wind, true));
        ...
        enemy.getPokemons().add(new Pokemon(1,10,10,10,"Bulbasaur", Pokemon.TypeP.Earth));
